...
import Trip7 from "../assets/moss.jpg";
import Trip8 from "../assets/titanium.jpg";
import Trip9 from "../assets/carbon.jpg";
// import Video from "./assets/video1.mp4";

function Trip() {
  return (
    <div id="products" className="trip">
      <h1>OUR PRODUCTS</h1>
      ...
      <div className="tripcard">
        <TripData
          image={Trip7}
          heading="MOSS"
          text="Elite Moss is a sleek, earthy green color. This can be used as an O.D. Green.
          "
        />
        <TripData
          image={Trip8}
          heading="TITANIUM"
          text="Developed in partnership with the team at SIG Sauer, DKS Coatings Elite Titanium is a soft, pewter silver metallic."
        />
        <TripData
          image={Trip9}
          heading="CARBON GREY"
          text="DKS Coatings is proud to partner with our friends at Browning to bring you DKS Elite Carbon Grey. Elite Carbon Grey is a cool, shadowy grey that is glazed with subtle silver metallics."
        />
      ...
      <h1 className="videoText">Our Other Products</h1> <br></br>

      <div className="tripcard">
        <h4 className="baslik-A">A</h4> <p className="product-A">
        <h4 className="altBaslik" id="1">Anti -Sticker Coatings</h4> <br></br>
        ...
        <h4 className="altBaslik" id="2">Anti- microbial Coatings</h4>   <br></br>
        Helping people achieve to meet increasing global cleaning demands.</p> 
      </div>
      
      <div className="tripcard">
        <h4 className="baslik-A"></h4> <p className="product-A">
        <h4 className="altBaslik" id="3">Abrasion Resistant Coatings</h4>  <br></br>
        Meeting the needs of the transportation and other industry today and for the future.</p> 
        <h4 className="baslik-I"></h4> <p className="product-I" id="3">Abrasion resistance coatings are applied to a substrate, or surface, to prevent mechanical damage that can result in surface imperfections.
         <br></br>
        </p> 
      </div>
      <br></br><hr></hr>
      <div className="tripcard">
        ...
        <h4 className="altBaslik" id="4">Bright Gold Leaf Paint 50 Years</h4>   <br></br>
        ...
        <h4 className="altBaslik" id="4">Building Industry</h4>  <br></br>
      ...
      <div className="tripcard">
        ...
        <h4 className="altBaslik" id="4">Durable Coatings</h4> <br></br>
        ...
        <h4 className="baslik-D"></h4> <p className="product-D" id="4">Durable coatings refer to chemical treatments that are applied to the face fabric of garments, tents, and sleeping bags to make them hydrophobic (water resistant).
         <br></br>
        </p> 
      </div>
      <br></br><hr></hr>
      <div className="tripcard">
        ...
        <h4 className="altBaslik" id="5">Electrical Insulation Coatings</h4> <br></br>
        ...
        <h4 className="altBaslik" id="5">Energy & Resources</h4>  <br></br>
      ...
      <div className="tripcard">
        ...
        <h4 className="altBaslik" id="8">Fire Protection Coatings</h4>   <br></br>
        ...
        <h4 className="altBaslik" id="10">Furniture & Wood</h4>  <br></br>
      ...
      <div className="tripcard">
        ...
        <h4 className="altBaslik" id="7">Gun Coatings</h4> <br></br>
        ...
        <h4 className="baslik-G"></h4> <p className="product-G" id="7">Gun coatings are chemical treatments applied to firearms to protect them from corrosion, increase their resistance to nicks and scratches, and enhance their appearance.
         <br></br>
        </p> 
      </div>
      <br></br><hr></hr>
      <div className="tripcard">
        ...
        <h4 className="altBaslik" id="11">HVAC Anti- microbial Coatings</h4>   <br></br>
        Supporting HVAC industry to create safer ventilation that are tailored to their specific clean room needs.</p> 
        <h4 className="baslik-H"></h4> <p className="product-H" id="11">HVAC antimicrobial coatings are chemical treatments applied to the surfaces of HVAC ductwork and other components to protect them from harmful microbial growth, such as bacteria
         <br></br>
        </p> 
      </div>
      <br></br><hr></hr>
      <div className="tripcard">
        ...
        <h4 className="altBaslik" id="12">Industrial Coatings</h4>  <br></br>
        Our range of industrial coatings are derived from experience, easy to use and durable solutions.</p> 
        <h4 className="baslik-I"></h4> <p className="product-I" id="12">Industrial coatings are a type of paint that is applied to various derivatives such as concrete or steel in order to provide both aesthetic and protective properties. 
        <br></br>
        </p> 
      </div>
      <br></br><hr></hr>
      <div className="tripcard">
        ...
        <h4 className="altBaslik" id="13">PVDF Clear for UV resistance</h4>  <br></br>
        ...
        <h4 className="altBaslik" id="14">Protection and Selective Sun Shading</h4>  <br></br>
      ...
      <div className="tripcard">
        <h4 className="baslik-P"></h4> <p className="product-P">
        <h4 className="altBaslik" id="15">PVDF Protected Bright Gold Paint </h4>  <br></br>
        ...
        <h4 className="baslik-P"></h4> <p className="product-P">
        <h4 className="altBaslik" id="16">Protected Bronze Paint</h4>  <br></br>
        Paint 1000 C resistant based paint materials for sustainable thermal regulation.</p> 
      </div>
      <div className="tripcard">
        <h4 className="baslik-P"></h4> <p className="product-P">
        <h4 className="altBaslik" id="17">PVDF Protected Brass Gold Paint</h4>  <br></br>
        ...
        <h4 className="baslik-P" id="18"></h4> <p className="product-P">PVDF (polyvinylidene fluoride) protected brass gold paint is a type of coating that is used to protect metal architecture and building components.
        <br></br>
        </p> 
      </div>
      <br></br><hr></hr>
      <div className="tripcard">
        ...
        <h4 className="altBaslik" id="23">Sound Blocking Paint 4</h4>  <br></br>
        ...
        <h4 className="altBaslik" id="23">Super Durable Coatings</h4>   <br></br>
      ...
      <div className="tripcard">
        ...
        <h4 className="altBaslik" id="24">Textile Coatings</h4> <br></br>
        Utilising expert industry knowledge to deliver innovative finishes for Textiles Accessories.</p><br></br> 
        <h4 className="baslik-T"></h4> <p className="product-T" id="24">Textile coatings are chemical treatments applied to textiles to enhance and extend their performance and aesthetic appeal.
           <br></br>
        </p> 
      </div>
      <br></br><hr></hr>
